...
#SBATCH --mem=32G
#SBATCH --time=00:30:00              # 30 mins for a 1-epoch test
#SBATCH --job-name=nnunet_test_train
#SBATCH --output=model004/train_output.log
#SBATCH --nodelist=gn-0011
...
# 5. Run a 2D network test on Fold 0 for exactly 1 epoch
nnUNetv2_train 4 2d 0 -tr nnUNetTrainer_1epoch
